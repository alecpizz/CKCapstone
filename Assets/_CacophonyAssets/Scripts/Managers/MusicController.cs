...
namespace Cacophony
{
    public class MusicController : MonoBehaviour
    {
        ...
        [SerializeField] float musicStartDelay = 2;

        [SerializeField] float musicEndDelay = 2;

        [SerializeField] bool useEnemyMusicScaling = false;

        [SerializeField] private List<string> _enemyMusicNames;
        ...
        private void Start()
        {
            _normalMusicVolume = AudioManager.Instance.GetAudioFile(AudioManager.Instance.Music, "MainTheme").Source
                .volume;
        ...
        private void FadeEnemyVolume()
        {
            ...
            {
                AudioManager.Instance.AdjustVolumeOverTime(_enemyMusicNames[i], 0, enemyMusicStartVolumes[i],
                    musicStartDelay);
            }
