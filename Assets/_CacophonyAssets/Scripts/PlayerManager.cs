...
public class PlayerManager : MonoBehaviour
{
    ...
    [Header("Components")]
    [SerializeField] HarmonyWave _playerWave;
    ...
    [HideInInspector]
    public UnityEvent SelectedTileChangeEvent;
...
/*        Debug.Log("PlayerStartingLocationAssigned");
        ...
        ExitLocationData Eld = GameplayManagers.Instance.Room.FindExitFromDirection(SaveSceneData.Instance.GetLastSceneDirection());
        GameplayManagers.Instance.Room.SetEntranceExit(Eld);

        transform.position = Eld.playerSpawnFromEntrance;
        GameplayManagers.Instance.Enemy.SetPlayerTile(GameplayManagers.Instance.Grid.DetermineGridSpaceFromPosition(transform.position));
