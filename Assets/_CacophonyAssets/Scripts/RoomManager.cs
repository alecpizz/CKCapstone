...
namespace Cacophony
{
    public class RoomManager : MonoBehaviour
    {
        ...
        [Space] [Header("Exits")] public Vector2Int positionOnLevelGrid;
                ...
                if (currentSaveData != null && currentSaveData.sceneID != -1)
                {
                    ...
                    foreach (ExitLocationData coords in exitSpawns)
                        if (coords.exitSpawnDirection == currentDir)
                        {
                            ...
                            newestExit.transform.position =
                                GameplayManagers.Instance.Grid.WorldPositionFromCoordinates(coords.exitSpawnLocation);
                    ...
                    Vector3 targetRotationEuler = new(0,
                        Quaternion.LookRotation(new Vector3(currentDir.x, 0, currentDir.y)).eulerAngles.y - 90, 0);
