...
namespace Cacophony
{
    ...
    public class WorldMap : MonoBehaviour
    {
        ...
        [Space] [SerializeField] private KeyElement _newRoom;
        ...
        public MapTile InstantiateGridTile(GameplayScenes scene)
        {
            ...
            mapTile.SetPositionFromCoordinates(scene.positionOnSceneGrid.x,
                scene.positionOnSceneGrid.y + minimapYOffset, _scale, anchorOffset);
