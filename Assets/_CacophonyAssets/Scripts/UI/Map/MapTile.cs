...
namespace Cacophony
{
    ...
    {
        [SerializeField] GameplayScenes Scene;
        ...
        {
            transform.position = new Vector3(transform.position.x + anchorPosition.x + x * scale * 2,
                transform.position.y + anchorPosition.y + y * scale * 2, 0);
        }
