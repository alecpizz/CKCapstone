...
//     version 1.7.0
//     from Assets/Input Actions/DebugtInputActions.inputactions
//
...
public partial class @DebugtInputActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @DebugtInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""DebugtInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @DebugtInputActions m_Wrapper;
        public UIActions(@DebugtInputActions wrapper) { m_Wrapper = wrapper; }
